...
function handle_message(event) {
  ...
  if (mic_buf.length >= sample_batch_size) {
    ...
    if (loopback_mode == "main") {
      ...
      samples_to_server(outdata, orig_read_clock, send_write_clock, window.userName.value, chatsToSend, requestedLeadPosition, target_url, loopback_mode).then((response) => {
