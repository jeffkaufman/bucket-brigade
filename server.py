...
class OurHandler(BaseHTTPRequestHandler):
    def do_OPTIONS(self):
        ...
        self.send_header("Access-Control-Allow-Headers", "Content-Type, X-Event-Data")
        self.end_headers()
    ...
    def do_POST(self):
        ...
        events_to_send = list(events.items())
        events_to_send = [ {"evid":i[0], "clock":i[1]} for i in events_to_send ]
